(function (){
    ...
    */
    ...
    console.log (text.replace (/Manuel Marques de Sousa/g, 'Eduarda Spironello'));
    ...
    */
    ...
    console.log (text.replace (/brasileiro/g, 'cedrense'));
    ...
    */
    console.log( '\nReplace de datas:' );
    function replaceDate (regexinteira, dia, mes, ano) {

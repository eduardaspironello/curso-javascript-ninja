(function () {
  ...
  */
  var challenge = [11, 12, 13, 14, 15];
  console.log( 'O array em formato de string é: ' + challenge.toString() );
  ...
  */
  var nordeste = ['Bahia', 'Sergipe', 'Rio Grande do Norte', 'Ceará', 'Paraíba', 'Alagoas', 'Maranhão', 'Pernanbuco', 'Piauí'];

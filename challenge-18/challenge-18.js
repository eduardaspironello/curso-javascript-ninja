...
'use strict'
    ...
    */
    ...
    cpfs.forEach (function (cpfs){
        console.log (cleanCPF(cpfs).replace (/(\d\d\d)(\d\d\d)(\d\d\d)(\d\d)/, '$1.$2.$3-$4'))
    });
    ...
    */
    ...
    var test = '<div><section><blockquote>Texto <img /></blockquote></section></div>';
    ...
    */
    ...
    var test2 = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
    console.log (test2.match (/<\w+><\/\w+>/g));
    ...
    */
    ...
    var test3 = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>';
    var regexTagHtml = test3.replace (/<(\w+)>([^<]+)<\/\w+>/g, '<$1>O texto dentro da tag "$1" eh "$2"</$1>\n');
